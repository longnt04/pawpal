...
export default function CreatePostModal({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-gray-900 rounded-2xl shadow-2xl max-w-lg w-full p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="flex items-center gap-3">
                ...
                <select
                  ...
                  className="flex-1 px-4 py-3 border border-gray-600 rounded-lg text-white bg-gray-800 focus:ring-2 focus:ring-pink-500 focus:border-transparent"
                  required
                >
                  {pets.map((pet) => (
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3 border border-gray-600 rounded-lg text-white bg-gray-800 focus:ring-2 focus:ring-pink-500 focus:border-transparent"
                rows={5}
                required
              />
            </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                <label className="flex items-center justify-center gap-2 w-full px-4 py-3 border-2 border-dashed border-gray-600 rounded-lg cursor-pointer hover:border-pink-500 transition">
            ...
            <div className="flex gap-3 pt-4">
              <button
                type="button"
                onClick={onClose}
                className="flex-1 px-6 py-3 border border-gray-600 text-gray-300 rounded-lg font-semibold hover:bg-gray-800 transition"
              >
                Hủy
              </button>
              <button
